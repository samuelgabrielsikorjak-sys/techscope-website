...
// the right column (assets/splash.js gates the start of this file's
// cycle — see window.__tsStartHeroViz below). Independent from
// assets/code-typer.js, which still runs the dual side-panel effect on
// the product pages.
//
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // otherwise assets/splash.js calls window.__tsStartHeroViz() itself
